...
class SchemaBuilder {
     ...
     */
    int() {
        return new _1.SchemaBuilderInt();
    }
    /**
     * Starts building a schema as an integers.
     * @return SchemaBuilderInt. It allows to set validations for integers.
     ...
     */
    enum(...params) {
        return new _1.SchemaBuilderEnum({}).enum(...params);
    }
    type(...types) {
        return new _1.SchemaBuilderGeneric({}, ...types);
    }
    $ref(ref) {
        return new _1.SchemaBuilderGeneric({}).$ref(ref);
    }
}
